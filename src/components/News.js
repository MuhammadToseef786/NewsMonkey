...
export class News extends Component {
  ...
  render() {
    ...
    return (
      <>
        <h1 className='text-center' style={{margin:'40px' , marginTop:'90px'}}>MyNews - Top {this.capitalizeFirstLetter(this.props.category)} Headlines</h1>
          ...
          <div className="container">
            <div className="row">
              {this.state.articles.map((element, index)=>{
                return <div className="col-md-4" key={element.url + index} title={element.title}>
